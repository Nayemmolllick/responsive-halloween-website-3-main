...
gsap.from(".home__titles", 1.5, {opacity: 0, y: -300, delay: .2, ease: "elastic.out(1, .5)"}) 
gsap.from(".home__tree", 2, {opacity: 0, y: 300, delay: .2, ease: "elastic.out(1, .5)"}) 
gsap.from(".home__data", 2, {opacity: 0, y: 200, delay: .2, ease: "elastic.out(1, .5)"}) 
